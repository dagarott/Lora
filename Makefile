##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.30.0] date: [Fri Sep 14 11:29:33 CEST 2018]
##########################################################################################################################
...
flash:
ifeq ($(OS),Windows_NT)
	c:/Program\ Files\ \(x86\)/SEGGER/JLink_V622d/JLink -if swd -device stm32l052k8 -commandfile jlinkcmd
else
	JLinkExe -if swd -device stm32l051k8 -speed auto -commandfile jlinkcmd
endif
#@echo "Flash-programming with JlinkExe"
#JLinkExe -if swd -device stm32l052k8 -commandfile jlinkcmd
